...
import com.example.cryptolist.data.network.model.CoinNameListDto
...
class CoinMapper {
    ...
    fun mapJsonContainerToListCoinInfoDto(jsonContainerDto: CoinInfoJsonContainerDto): List<CoinInfoDto> {
